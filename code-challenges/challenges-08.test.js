...
const containsW = (str) => {
  // Solution code here...
  let isItw = /w/g;
  return str.match(isItw) ? true : false;
};
...
const isNum = (input) => {
  // Solution code here...
  let isItnum = /\d/g;
  return String(input).match(isItnum) ? true : false;
};
...
const containsWorld = (input) => {
  // Solution code here...
  let isItworld = /world/g;
  return String(input).match(isItworld) ? true : false;
};
...
const isCapitalized = (str) => {
  // Solution code here...
  let isItA = /\b[A-Z][a-z]+/g;
  return str.match(isItA) ? str.match(isItA) : [];
};
...
const citiesAtoJ = (arr) => {
  // Solution code here...
  let isItA_J = /^[A-J]/;
  return arr.filter(a => isItA_J.test(a));
};
/* ------------------------------------------------------------------------------------------------
